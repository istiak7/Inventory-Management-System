...
namespace Inventory_Management_System.Features.Products.Shared.Repository
{
    ...
    {
        Task<PagedResult<ProductResponse>> GetAllPagedAsync(
            int pageNumber,
            int pageSize,
            CancellationToken cancellationToken = default
        );
        Task<PagedResult<ProductResponse>> GetBySubCategoryIdPagedAsync(
            int subCategoryId,
            int pageNumber,
            int pageSize,
            CancellationToken cancellationToken = default
        );
        Task<PagedResult<ProductResponse>> GetByBrandIdPagedAsync(
            int brandId,
            int pageNumber,
            int pageSize,
            CancellationToken cancellationToken = default
