            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                return new Result
                {
                    ...
                    StatusCode = 200,
                    Status = "Success",
                    Message = "Branch stock retrieved successfully",
                    Data = response
                };
            }
            catch (Exception ex)
            {
                _logger.LogError(
                    ex,
                    "Error retrieving stock for branch {BranchId}",
                    request.BranchId);
                ...
                return new Result
                {
                    ...
                    StatusCode = 500,
                    Status = "Error",
                    Message = "An error occurred while retrieving branch stock."
                };
            }
        }
    }
